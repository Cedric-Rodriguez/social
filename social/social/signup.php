	...
	<div id="container">
		...
		<form method="post" action="signup_form.php" enctype="multipart/form-data">
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td><input type="text" name="firstname" placeholder="" class="form-1" title="Enter your firstname" required /></td>
					<td><input type="text" name="lastname" placeholder="" class="form-1" title="Enter your lastname" required /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="text" name="username" placeholder="" class="form-1" title="Enter your username" required /></td>
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td><input type="text" name="email" placeholder="" class="form-1" title="Enter your firstname" required /></td>
				...
				<tr>
					<td><input type="password" name="password" placeholder="" class="form-1" title="Enter your username" required /></td>
